...
WHY THIS EXISTS. docs/investigation/THEMES/T10 phases 11-14 narrowed the PC MASTER OUT fault to a
...
(research/probes/alsapulse.py: 0 hw_ptr stalls across 4 cycles).
...
WHAT IT MEASURES, read-only, no debugger:
  ...
  * the two device queue depths (same technique as research/probes/queuescope.py)
...
Usage: research/probes/threadpulse.py <pid> [seconds]
"""
import sys, os, time
