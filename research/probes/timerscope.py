...
WHY THIS EXISTS. docs/investigation/THEMES/T10 phase 11 measured the audio fault's trigger to a
...
can then be neutered individually and scored with research/probes/queuescope.py.

Usage: research/probes/timerscope.py <pid> [--period MS]
"""
