...
WHY THIS EXISTS. docs/investigation/THEMES/T10 phase 11: every 15.85 s the DDJ's output queue
...
`research/probes/queuescope.py --trace` writes in its header.
...
Usage: research/probes/alsapulse.py <card> [seconds] [pcm] [--trace f.tsv]
"""
import sys, time, os
