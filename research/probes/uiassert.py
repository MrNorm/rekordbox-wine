...
USAGE
    research/probes/uiassert.py --shot runs/X/main.png                 report all regions
    research/probes/uiassert.py --shot X.png --expect baseline         assert baseline states
    research/probes/uiassert.py --shot X.png --expect milestone        assert the MIDI milestone
    research/probes/uiassert.py --capture --expect baseline            capture, then assert
    research/probes/uiassert.py --shot X.png --block audio_prefs --json    grade another window
