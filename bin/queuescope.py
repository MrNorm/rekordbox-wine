...
WHY THIS EXISTS. THEMES/T10 phase 8 established, at runtime, that the 15.9 s
...
Usage: bin/queuescope.py <pid> [seconds]              # scan for the devices
       bin/queuescope.py <pid> <engine-hex> [seconds] # or via a known engine
