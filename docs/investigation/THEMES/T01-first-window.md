...
period from QPC; ~30 lines, in `upstream/patches/0001-dxgi-implement-WaitForVBlank.patch`).
...
- [ ] AppDB test report for 7.2.17 on wine-staging 11.15 / Intel Iris Xe — drafted
      in `upstream/reports/appdb-rekordbox-7217.md`, needs a logged-in account to post
