...
in PipeWire and re-run `research/probes/meterscope.py`, which scores the rebuild cycle
...
`research/probes/pwclash.sh`. One variable: an ordinary `aplay -D hw:1,0` holds the DDJ's
