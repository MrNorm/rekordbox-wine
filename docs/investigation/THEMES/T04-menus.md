...
`research/probes/menuprobe.sh`, 5 passes, clicking each top-level menu with a full state
...
`research/probes/popupcensus.sh`, three passes each, with a deliberate slow reset between
